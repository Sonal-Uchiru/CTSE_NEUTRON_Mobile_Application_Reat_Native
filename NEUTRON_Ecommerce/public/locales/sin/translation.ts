const sin = {
  ...
  helpPage: {
    ...
    cardStep02: '"නව කාඩ්පත එක් කරන්න" බොත්තම ක්ලික් කිරීමෙන් නව කාඩ්පත එක් කරන්න',
    cardStep03: '"කාඩ්පත් සංස්කරණය කරන්න" ක්ලික් කිරීමෙන් කාඩ්පත් සංස්කරණය කරන්න',
    cartStep01: 'ඔබගේ කරත්තයට අයිතම එක් කිරීමට "කරත්තයට එකතු කරන්න" බොත්තම ඔබන්න',
