...
export default function UnsavedLeaveDialog({ isVisible, dismissFunc }: props) {
...
const styles = (theme: {
  COLORS: { WARNING: string; WHITE: string; ERROR: string };
  TYPOGRAPHY: {
    FONT_WEIGHT: any;
